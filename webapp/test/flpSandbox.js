		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "fiori egitim",
									"targetURL": "#tirsanfioriegitim-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"tirsanfioriegitim-display": {
								"semanticObject": "tirsanfioriegitim",
								"action": "display",
								"description": "fiori egitim",
								"title": "fiori egitim",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=tirsan.fioriegitim",
									"url": sap.ui.require.toUrl("tirsan/fioriegitim")
								}
							}
						}
					}
